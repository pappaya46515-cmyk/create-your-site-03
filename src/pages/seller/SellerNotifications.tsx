...
import { Bell, BellOff, Check, Calendar, Info, CheckCircle, AlertCircle, FileText, MessageCircle, Car } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Notifications</h1>
